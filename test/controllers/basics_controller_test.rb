...
class BasicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basic" do
    assert_difference('Basic.count') do
      post basics_url, params: { basic: { category: @basic.category, description: @basic.description, name: @basic.name, references: @basic.references } }
    end
  ...
  test "should update basic" do
    patch basic_url(@basic), params: { basic: { category: @basic.category, description: @basic.description, name: @basic.name, references: @basic.references } }
